...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector("input[name=email]"),o=document.querySelector("textarea[name=message]"),s=document.querySelector("button[type=submit]"),l={email:"",message:""},n=localStorage.getItem("feedback-form-state");function r(){l.email=a.value,localStorage.setItem("feedback-form-state",JSON.stringify(l)),console.log(l)}function u(){l.message=o.value,localStorage.setItem("feedback-form-state",JSON.stringify(l)),console.log(l)}function c(e){e.preventDefault();const t=JSON.parse(n);console.log("user info submited: ",t),localStorage.removeItem("feedback-form-state"),a.value="",o.value=""}function m(){n&&(a.value=JSON.parse(n).email,o.value=JSON.parse(n).message,console.log(`в хранилище осталось email = ${JSON.parse(n).email} и message = ${JSON.parse(n).message}`))}a.addEventListener("input",(0,e.default)(r,500)),o.addEventListener("input",(0,e.default)(u,500)),s.addEventListener("click",c),m();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.41b8843f.js.map